...
switch ($Target) {
    ...
    "eval"      { uv run python scripts/evaluate.py --all-variants; uv run python scripts/ope.py --all-variants }
    ...
    "all"       { uv sync --all-groups; uv run python scripts/make_data.py --all-variants; uv run python scripts/train.py --all-variants; uv run python scripts/evaluate.py --all-variants; uv run python scripts/ope.py --all-variants; uv run python scripts/run_batch.py --n 500 --inject-failure }
